...
export default function DropdownWithCreate(props: DropdowntWithCreateContainerProps) {
    ...
    const validationFeedback = props.searchValue.validation;
    const validationReactNode = <Alert>{validationFeedback}</Alert>;
